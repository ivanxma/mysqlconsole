...
def fetch_db_admin_routine_rows(database_name=""):
    ...
    rows = execute_query(
        ...
        SELECT
          ...
          character_set_client AS character_set_client_value,
          collation_connection AS collation_connection_value,
          database_collation AS database_collation_value,
    ...
    return [
        {
            ...
            "character_set_client": row["character_set_client_value"] or "-",
            "collation_connection": row["collation_connection_value"] or "-",
            "database_collation": row["database_collation_value"] or "-",
...
def fetch_db_admin_routine_detail(database_name, routine_name, routine_type):
    ...
    return {
        ...
        "character_set_client": metadata["character_set_client_value"] or "-",
        "collation_connection": metadata["collation_connection_value"] or "-",
        "database_collation": metadata["database_collation_value"] or "-",
