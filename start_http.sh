...
export HOST PORT DBCONSOLE_MYSQLSH DBCONSOLE_PYTHON_BIN DBCONSOLE_PYTHON_MIN_VERSION DBCONSOLE_LISTENER_SCHEME DBCONSOLE_SESSION_COOKIE_SECURE DBCONSOLE_UPDATE_ALLOWED_REMOTE_URL DBCONSOLE_UPDATE_ALLOWED_BRANCH DBCONSOLE_OBJECT_STORAGE_REGION
