...
`.runtime.env`, `profiles.json`, `object_storage.json`, and `tls/` are git-ignored local state. The auto-update worker allows local changes to these files during the repository clean-check.
